...
ADXL345::setTapThreshold(int16_t tapThreshold) {
    tapThreshold = std::min(std::max(tapThreshold, int16_t(0)), int16_t(255));
...
ADXL345::setTapDuration(int16_t tapDuration) {
    tapDuration = std::min(std::max(tapDuration, int16_t(0)), int16_t(255));
...
ADXL345::setDoubleTapWindow(int16_t floatTapWindow) {
    floatTapWindow = std::min(std::max(floatTapWindow, int16_t(0)), int16_t(255));
...
ADXL345::setActivityThreshold(int16_t activityThreshold) {
    activityThreshold = std::min(std::max(activityThreshold, int16_t(0)), int16_t(255));
...
ADXL345::setInactivityThreshold(int16_t inactivityThreshold) {
    inactivityThreshold = std::min(std::max(inactivityThreshold, int16_t(0)), int16_t(255));
...
ADXL345::setTimeInactivity(int16_t timeInactivity) {
    timeInactivity = std::min(std::max(timeInactivity, int16_t(0)), int16_t(255));
...
ADXL345::setFreeFallThreshold(int16_t freeFallThreshold) {
    freeFallThreshold = std::min(std::max(freeFallThreshold, int16_t(0)), int16_t(255));
...
ADXL345::setFreeFallDuration(int16_t freeFallDuration) {
    freeFallDuration = std::min(std::max(freeFallDuration, int16_t(0)), int16_t(255));
